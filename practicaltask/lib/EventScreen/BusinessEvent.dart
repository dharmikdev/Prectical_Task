...
class BusinessEventScreen extends StatefulWidget {
  const BusinessEventScreen({Key? key}) : super(key: key);

  @override
  State<BusinessEventScreen> createState() => _BusinessEventScreenState();
}

class _BusinessEventScreenState extends State<BusinessEventScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: Colors.white70,
        toolbarHeight: 50,
        title: Text("Business Events Page",style: TextStyle(color: Colors.black)),
      ),
  ...
  Future<void> selecteduserinlist() async {
    ...
    apiService.businesseventlist().then(
          (value) => setState(() {

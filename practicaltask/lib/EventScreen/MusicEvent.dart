...
class MusicEventscreen extends StatefulWidget {
  const MusicEventscreen({Key? key}) : super(key: key);

  @override
  State<MusicEventscreen> createState() => _MusicEventscreenState();
}
...
class _MusicEventscreenState extends State<MusicEventscreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: Colors.white70,
        toolbarHeight: 50,
        title: Text("Music Events Page",style: TextStyle(color: Colors.black)),
      ),
  ...
  Future<void> selecteduserinlist() async {
    ...
    apiService.musiceventlist().then(
          (value) => setState(() {
